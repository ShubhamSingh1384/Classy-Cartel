...
//create products
exports.createProduct = catchAsyncErrors (async (req,res,next)=>{  //here catchAsyncErrors function is imported and used to handle error like try and catch. 
...
exports.getProductDetails = catchAsyncErrors( async(req,res,next)=>{
    ...
    if(!product){
        return next(new ErrorHander("Product not found",404));  //here ErrorHander is used for  custom error handling
